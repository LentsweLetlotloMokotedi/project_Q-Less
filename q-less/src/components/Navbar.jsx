  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex gap-6 text-white/80 font-medium">
        ...
        <button onClick={goToDashboard} className="hover:text-white transition">Live Queue</button>
      ...
      {menuOpen && (
        ...
        >
          <button onClick={() => scrollToSection("home")} className="text-white hover:text-blue-400 transition">Home</button>
          <button onClick={goToDashboard} className="text-white hover:text-blue-400 transition">Live Queue</button>
          <button onClick={() => scrollToSection("features")} className="text-white hover:text-blue-400 transition">Features</button>
